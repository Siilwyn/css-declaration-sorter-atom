...
Sorts your CSS declarations in Atom, never gets tired. If you want to define a sort order project-wide check out the [css-declaration-sorter](https://cdn.rawgit.com/Siilwyn/css-declaration-sorter-atom/master/show-off.gif) Node.js module.
